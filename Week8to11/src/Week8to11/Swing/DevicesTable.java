...
public class DevicesTable {
    ...
    public DevicesTable() {
        ...
        btnConnection = new JButton("Add Connection");
        btnConnection.setBounds(50, 50, 150, 30);
        btnAddNew = new JButton("Add New Device");
        btnAddNew.setBounds(220, 50, 200, 30);
        btnShowConnection = new JButton("Show Connection");
        btnShowConnection.setBounds(440, 50, 200, 30);
